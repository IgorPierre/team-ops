...
export function SiteFooter({ navLabel }: { navLabel: string }) {
  ...
  return (
    <footer className="border-t border-rule">
      <div className={cn(wrap, "py-12 pb-[max(3rem,env(safe-area-inset-bottom))] md:flex md:items-center md:justify-between")}>
        ...
        <p className="mt-8 flex items-center justify-center gap-2 text-center text-sm/6 text-muted md:order-1 md:mt-0 md:justify-start">
